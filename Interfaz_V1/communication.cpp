...
{
// si la dirección IP esta cargada
    ...
    ClientSocket1->Active=true;   //inicio la conexión

// actualizo información de estado:
        ...
        TCustomWinSocket *Socket, TErrorEvent ErrorEvent, int &ErrorCode)
{
    ...
    Application->MessageBoxA("Asegurese que la aplicación servidor esté conectada", "Error de comunicación", MB_OK);
}
//---------------------------------------------------------------------------
